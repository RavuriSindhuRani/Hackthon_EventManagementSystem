...
@Component({
  selector: 'app-volunteerevents',
  templateUrl: './volunteerevents.component.html',
  styleUrl: './volunteerevents.component.css'
})
export class VolunteereventsComponent implements OnInit {
  ...
  openRegistrationModal(eventId: string, capacity: number = 999, assignedCount: number = 0): void {
  ...
  registerVolunteer(): void {
    ...
    formData.append('image', blob, 'volunteer_face.jpg');
  ...
  handleImage(webcamImage: WebcamImage): void { this.webcamImage = webcamImage; }
